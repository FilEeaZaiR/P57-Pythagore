...
client.login('NDgyMTI4NDI3MjM1ODAzMTM3.DmA_Lg.o54B5uBo1WXmnunFKvb37Z_zFvM');
...
if(!bvn) return;
bvn.send(`Bienvenue ${member}, n'hésite pas à lire les #règles pour plus d'informations !`)
})
